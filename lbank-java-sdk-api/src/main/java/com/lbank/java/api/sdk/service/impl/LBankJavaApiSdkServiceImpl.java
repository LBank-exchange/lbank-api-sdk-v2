...
public class LBankJavaApiSdkServiceImpl {
     ...
     * @return
     */
    public ResCreateOrderVo createOrder(String symbol, String type, String price, String amount,String customerId) throws Exception {
        ...
        return LBankJavaApiSdkServiceGenerator.executeSync(this.lBankJavaApiService.createOrder(symbol, type, price, amount,customerId));
    }
