...
# 发布的maven模块名
deploy_module='exchange-app'
# maven打包后的war包名
package_name='exchange-app.war'
# 服务器上的发布路径
server_deloy_path='/opt/server/app'
# API进程名字
process_name='app'
...
echo '开始复制新包...'
mv ${project_root}/exchange-app/target/${package_name} ${server_deloy_path}/www/ROOT.war
