...
# 发布的maven模块名
deploy_module='exchange-bus-service'
# maven打包后的war包名
package_name='exchange-bus-service.war'
# 服务器上的发布路径
server_deloy_path='/opt/bus-service'
# API进程名字
process_name='bus-service'
...
echo '开始复制新包...'
mv ${project_root}/${deploy_module}/target/${package_name} ${server_deloy_path}/www/${package_name}.war
